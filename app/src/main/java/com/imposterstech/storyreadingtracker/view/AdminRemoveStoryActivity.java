...
public class AdminRemoveStoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_remove_story);
        init();
    }
    ...
    void init(){
        recyclerViewAllStories=findViewById(R.id.recyclerview_admin_removestory_page);
        ...
        call.enqueue(new Callback<List<StoryModel>>() {
            ...
            public void onResponse(Call<List<StoryModel>> call, Response<List<StoryModel>> response) {
                if(response.isSuccessful()){
                    ...
                    RVAdminRemoveStoryAdapter rvAdminRemoveStoryAdapter=new RVAdminRemoveStoryAdapter(allStories);
                    recyclerViewAllStories.setAdapter(rvAdminRemoveStoryAdapter);
